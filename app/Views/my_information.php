    ...
    <div class="container-fluid bg-light py-5">
        ...
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="card-header bg-white border-0 p-0">
                ...
                <form id="myInformation" action="<?= site_url('user/my-information/update/') . $user['cedula'] ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                ...
                <script>
                    ...
                    document.getElementById('myInformation').addEventListener('submit', function (e) {
                        e.preventDefault(); // Prevenir el envío normal del formulario

                        // Aquí generalmente harías un envío AJAX
                        // Para este ejemplo, simularemos una respuesta exitosa
                        fetch('<?= base_url('index.php/user/my-information/update/') . $user['cedula'] ?>', {
                            method: 'POST',
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        // Verificar si el elemento 'academic_level' existe antes de intentar agregar el event listener
                        ...
                        if (academicLevel) {
                            ...
                            // Habilitar o deshabilitar el área de conocimiento según el nivel académico al cargar la página
                            var areaOfKnowledge = document.getElementById('area_knowledge');
                            if (areaOfKnowledge) {
